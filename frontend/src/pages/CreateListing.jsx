...
const CreateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      listingForm.append("amenities", amenities); // This should be an array
      ...
      console.log("Listing Form Data:", listingForm); // Log the form data

      const res = await fetch("http://localhost:9999/api/listing/create", {
        method: "POST",
        body: listingForm,
      })
