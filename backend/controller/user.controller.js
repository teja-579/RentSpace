...
// Add the getReservationList function export
...
// Add the updateProfile function export
export const updateProfile = async (req, res, next) => {
  ...
  try {
    ...
    console.log("Phone number being updated:", req.body.phone); // Log the phone number being updated
    ...
    const updatedUser = await user.save(); // Save the user and capture the updated user
